...
Frågan blir mer akut när verktygen får agera på egen hand. Vår genomgång av [AI-agenter](/jobb/ai-agenter/) tar upp varför ett system som själv klickar, skickar och raderar kräver tydligare gränser än en chattbot som bara svarar. För djupare bakgrund, se vår genomgång av [GDPR och ChatGPT](/integritet/gdpr-chatgpt/) och [dina data i AI-tjänster](/integritet/dina-data-i-ai/).
...
<Figure src="/images/inline/ai-policy-arbetsplats.webp" alt="Möte där policydokument diskuteras" caption="" />
...
- **Loggar centralt** vilka AI-verktyg som är aktiva i organisationens nätverk (via Microsoft Defender för Cloud Apps eller liknande).
...
**Blanketförbud mot ChatGPT.** Det fungerar inte. Anställda kommer använda det ändå på privata enheter, vilket är värre. Det är så [skugg-AI](/jobb/skugg-ai/) uppstår, alltså AI-användning som ledningen inte vet om och inte kan styra. Bättre att tillåta betald version där träning är avstängd och tydliggöra vilken data som inte får matas in.
